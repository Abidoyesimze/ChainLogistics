...
pub fn health_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/health/live", get(crate::handlers::health::liveness_check))
        .route("/health/ready", get(crate::handlers::health::readiness_check))
        .route("/health/db", get(crate::handlers::health::db_health_check))
        .route("/health/monitoring", get(crate::handlers::health::monitoring_health))
}
